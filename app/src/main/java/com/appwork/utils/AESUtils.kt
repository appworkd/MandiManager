...
object AESUtils {
    private val keyValue = byteArrayOf('v'.toByte(), 'i'.toByte(), 'v'.toByte(), 'e'.toByte(), 'k'.toByte(), 'c'.toByte(), 'h'.toByte(), 'a'.toByte(), 'u'.toByte(), 'd'.toByte(), 'h'.toByte(), 'a'.toByte(), 'r'.toByte(), 'y'.toByte(), 'o'.toByte(), 'm'.toByte())
